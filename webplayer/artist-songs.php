...
if (isset($_REQUEST['aid'])) {
	...
	$sql = "SELECT songs_table.id, songs_table.name AS sname, genre_table.name AS gname, artist_table.name AS aname FROM songs_table LEFT JOIN genre_table ON songs_table.genre_id = genre_table.id LEFT JOIN artist_table ON songs_table.artist_id = artist_table.id WHERE songs_table.artist_id = ?";
            ...
            <div class="music-head">
                <div class="music-head-item">
                    ...
                    <?php if (!isset($_REQUEST['aid'])) {
                        echo '<h1>All Artist Song List</h1>';
                    } else if($emp) {
...
<?php $count = 1; ?>
        ...
        <?php foreach ($arr_song as $key) { ?>
                ...
                <a href="./artist-songs.php?aid=<?php echo $_REQUEST['aid']; ?>&id=<?php echo $key['id']; ?>" class="music-col">
                    <div class="music-img">
