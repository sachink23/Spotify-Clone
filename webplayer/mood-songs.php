...
if (isset($_REQUEST['mid'])) {
	...
	$sql = "SELECT songs_table.id, songs_table.name AS sname, genre_table.name AS gname, artist_table.name AS aname FROM songs_table LEFT JOIN genre_table ON songs_table.genre_id = genre_table.id LEFT JOIN artist_table ON songs_table.artist_id = artist_table.id WHERE songs_table.mood_id = ?";
...
<section id="section-main">
    <div class="filterNav">
        ...
        <a href="./mood.php" class="filterNav-link active">Mood</a>
...
<?php $count = 1; ?>
        ...
        <?php foreach ($arr_song as $key) { ?>
                ...
                <a href="./mood-songs.php?mid=<?php echo $_REQUEST['mid']; ?>&id=<?php echo $key['id']; ?>" class="music-col">
                    <div class="music-img">
